...
class ThreatActor(BaseModel):
    ...
    targeted_regions: Optional[List[str]] = []
    techniques: str
    notable_incidents: str
    defenses: str
    description: str
    additional_description: str
    malware_tools: Optional[List[str]] = []
    weaponized_cves: Optional[List[str]] = []
    mitre_matrix: Optional[List[Dict[str, Any]]] = []
    incident_cases: Optional[List[Dict[str, Any]]] = []
    c2_infrastructure: Optional[str] = None
    yara_rule_guidance: Optional[str] = None
...
_cached_actors = PRECONFIGURED_ACTORS
