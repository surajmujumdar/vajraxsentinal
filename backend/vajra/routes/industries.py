...
class IndustryTarget(BaseModel):
    ...
    downtime_cost_per_hour: Optional[str] = None
    regulatory_frameworks: Optional[List[str]] = []
    real_world_case_studies: Optional[List[Dict[str, Any]]] = []
    threat_landscape_analysis: Optional[str] = None
    defense_hardening_checklist: Optional[List[Dict[str, Any]]] = []
