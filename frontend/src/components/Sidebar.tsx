  ...
  return (
    <aside
      style={{
        ...
        zIndex: 50,
        userSelect: 'none',
        boxShadow: '4px 0 25px rgba(2, 6, 23, 0.8)',
    ...
    >
      ...
      <Link
        ...
        style={{
          ...
          gap: '10px',
          cursor: 'pointer',
          background: 'linear-gradient(180deg, rgba(15, 29, 66, 0.4) 0%, rgba(4, 8, 20, 0.9) 100%)',
          flexShrink: 0
        }}
      >
        <div
        ...
        {!collapsed && (
          <div style={{ minWidth: 0, flex: 1 }}>
            <div style={{ fontSize: '13px', fontWeight: 800, letterSpacing: '1px', color: '#ffffff', lineHeight: 1.1 }}>
              VAJRA <span className="text-[10px] text-cyan-400 font-mono">V3.4</span>
            </div>
            <div style={{ fontSize: '7.5px', fontWeight: 800, color: '#38bdf8', marginTop: '1px', letterSpacing: '0.6px', textTransform: 'uppercase', fontFamily: 'var(--font-mono)' }}>
              THREAT • INTEL • RADAR
            </div>
          </div>
        )}
        ...
        {navSections.map((section, sIdx) => (
          <div key={sIdx} style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
            ...
            {section.items.map((item) => {
              ...
              const iconAccent = item.color || (active ? '#00f2fe' : '#64748b')
              ...
              return (
                <Link
                  ...
                  style={{
                    ...
                    borderRadius: '6px',
                    background: active
                      ? 'linear-gradient(90deg, rgba(6, 182, 212, 0.22) 0%, rgba(37, 99, 235, 0.08) 100%)'
                      : 'transparent',
                    border: active ? '1px solid rgba(56, 189, 248, 0.6)' : '1px solid transparent',
                    boxShadow: active ? '0 0 16px rgba(0, 242, 254, 0.25)' : 'none',
                ...
                >
                  ...
                  >
                    <Icon
                      size={15}
                      color={active ? '#00f2fe' : iconAccent}
                      strokeWidth={active ? 2.5 : 2}
                      style={{
                        filter: active ? 'drop-shadow(0 0 6px #00f2fe)' : 'none'
                      }}
                    />
                  </div>
      ...
      >
        <button
          ...
          style={{
            ...
            padding: '6px 0',
            borderRadius: '6px',
            backgroundColor: 'rgba(7, 15, 36, 0.8)',
          ...
          className="hover:border-cyan-400 hover:text-cyan-300 hover:shadow-[0_0_12px_rgba(0,242,254,0.3)]"
